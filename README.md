...
This project provides a complete end-to-end (E2E) DevOps automation pipeline for deploying microservices using modern DevOps tools. Maintained by Aman Behera, it sets up a local Kubernetes environment using Terraform, Ansible, Docker, and Kubernetes (k8s), deploys services using Helm charts, and automates CI/CD with GitHub Actions using self-hosted runners.
